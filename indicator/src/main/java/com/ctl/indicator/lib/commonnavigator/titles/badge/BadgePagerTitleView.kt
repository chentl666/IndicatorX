 ...
 * Date: 2020/07/06
 */
open class BadgePagerTitleView(context: Context) : FrameLayout(context), IMeasurablePagerTitleView {
    ...
    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        ...
        if (mInnerPagerTitleView is View && mBadgeView != null) {
            ...
            if (mInnerPagerTitleView is IMeasurablePagerTitleView) {
                val view = mInnerPagerTitleView as IMeasurablePagerTitleView
